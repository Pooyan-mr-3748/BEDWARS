...
use sergittos\bedwars\provider\mysql\task\UpdateLevelTask;
...
class MysqlProvider extends Provider {
    ...
    public function updateLevel(Session $session): void {
    $this->scheduleAsyncTask(new UpdateLevelTask($session));
}
